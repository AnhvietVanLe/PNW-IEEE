class MembersController < ApplicationController
  ...
  private
    ...
    def member_params
      params.require(:member).permit(:first_name, :last_name, :email, :phone, :ieee_membership_number, :ieee_membership_grade, :ieee_membership_status, :ieee_hkn, :major, :grade_year, :grad_date, :linkedin_username, :discord_username, :profile_picture, :soldering_workshop, :battery_workshop, :_3d_workshop)
    end
end